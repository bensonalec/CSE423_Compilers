...
class import_ir():
    ...
    def parse(self):
        ...
        head = pg.getTree()
        #here, sort the list of IRNodes that have been generated by the parser, since the bottom up nature of the parse means it will parse function_definitions after lines
        finalLs = []
        tempLs = []
        for i in pg.ls:
