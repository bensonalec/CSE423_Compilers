...
class Parser():
    ...
    def parse(self):
        ...
        @self.pg.production('loop : WHILE_LOOP OPEN_PAREN collation CLOSE_PAREN content ')
        def loop___WHILE_LOOP_OPEN_PAREN_collation_CLOSE_PAREN_content_(p):
            """
            Boilerplate BNF function
            param: p: the matching set of tokens
            :return: The node of the abstract syntax tree
        ...
        @self.pg.production('loop : DO_LOOP content WHILE_LOOP OPEN_PAREN collation CLOSE_PAREN SEMICOLON ')
        def loop___DO_LOOP_content_WHILE_LOOP_OPEN_PAREN_collation_CLOSE_PAREN_SEMICOLON_(p):
            """
            Boilerplate BNF function
            param: p: the matching set of tokens
            :return: The node of the abstract syntax tree
        ...
        @self.pg.production('branch : IF_BRANCH OPEN_PAREN collation CLOSE_PAREN content ')
        def branch___IF_BRANCH_OPEN_PAREN_collation_CLOSE_PAREN_content_(p):
            """
            Boilerplate BNF function
            param: p: the matching set of tokens
            :return: The node of the abstract syntax tree
        ...
        @self.pg.production('branch : ELSE_BRANCH IF_BRANCH OPEN_PAREN collation CLOSE_PAREN content ')
        def branch___ELSE_BRANCH_IF_BRANCH_OPEN_PAREN_collation_CLOSE_PAREN_content_(p):
            """
            Boilerplate BNF function
            param: p: the matching set of tokens
            :return: The node of the abstract syntax tree
